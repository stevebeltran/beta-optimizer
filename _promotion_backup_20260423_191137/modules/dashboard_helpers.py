...
def prepare_runtime_context(
    ...
    with budget_expander:
        ...
        dfr_dispatch_rate = st.slider('DFR Dispatch Rate', 1, 100, session_state.get('dfr_rate', 30), label_visibility='collapsed') / 100.0
        ...
        deflection_rate = st.slider('Resolution Rate', 0, 100, session_state.get('deflect_rate', 30), label_visibility='collapsed') / 100.0
