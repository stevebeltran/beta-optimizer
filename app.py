...
# OPTIMIZATION: max_entries=1 prevents OOM kills on 1GB instances
    ...
    if k_responder + k_guardian > n:
        ...
        with st.spinner(f"Optimizing..."):
            ...
            if total_possible > 3000:
                ...
                # OPTIMIZATION: Process sequentially to avoid Streamlit Cloud's BrokenProcessPool errors
                combos_to_test = []
                ...
                results = [evaluate_combo(combo) for combo in combos_to_test]
